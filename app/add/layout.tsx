...
const layout = ({children }: {children: React.ReactNode}) => {
  ...
  return (
    <div>
          <div className="fixed z-50 top-0 left-0 right-0 justify-center items-center grid 
            max-w-xs grid-cols-3 gap-1 p-1 mx-auto my-2 bg-gray-100 rounded-lg dark:bg-gray-600" role="group">
